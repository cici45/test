...
public class HistoryMedical : MonoBehaviour
{
    Text[] DataArr;
    BarChart barChart;
    float[] AngleData, strengthData, enduranceData;
    public static string AngleDataText;
    public static string enduranceDataText;
    public static string strengthDataText;
    ...
    {
        string[] tempArr1 = AngleDataText.Split('_');
        string[] tempArr2 = strengthDataText.Split('_');
        string[] tempArr3 = enduranceDataText.Split('_');
