...
namespace XCharts
{
    ...
    public class XChartsMgr : MonoBehaviour
    {
        ...
        //ADD 2022/9/19
        public BaseChart GetChart(BaseChart chart)
        {
            return m_ChartList.Find(e => e == chart);
        }
        ...
        {
            if (m_ChartList != null && m_ChartList.Contains(chart))
            {
                m_ChartList.Remove(chart);
            }
        }
        public bool ContainsChart(string chartName)
        {
            if (string.IsNullOrEmpty(chartName)) return false;
            return GetCharts(chartName) != null && GetCharts(chartName).Count > 0;
        }
